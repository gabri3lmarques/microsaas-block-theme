...
interface SelectProps extends Pick<SelectControlProps, 'disabled' | 'multiple' | 'variant'> {
    selectSize?: SelectControlProps['size'];
}
export declare const StyledInputBase: import("@emotion/styled").StyledComponent<import("../../input-control/types").InputBaseProps & import("react").RefAttributes<any> & Omit<Omit<import("react").DetailedHTMLProps<import("react").HTMLAttributes<HTMLDivElement>, HTMLDivElement>, "ref">, "as" | keyof import("../../input-control/types").InputBaseProps | keyof import("react").RefAttributes<any>> & {
...
export declare const InputControlSuffixWrapperWithClickThrough: import("@emotion/styled").StyledComponent<import("../../input-control/types").PrefixSuffixWrapperProps & import("react").RefAttributes<any> & Omit<Omit<import("react").DetailedHTMLProps<import("react").HTMLAttributes<HTMLDivElement>, HTMLDivElement>, "ref">, "as" | keyof import("../../input-control/types").PrefixSuffixWrapperProps | keyof import("react").RefAttributes<any>> & {
    as?: import("react").JSXElementConstructor<any> | keyof import("react").JSX.IntrinsicElements | undefined;
} & {
    theme?: import("@emotion/react").Theme;
}, {}, {}>;
