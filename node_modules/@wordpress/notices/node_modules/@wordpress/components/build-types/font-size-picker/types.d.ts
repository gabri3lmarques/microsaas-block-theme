...
export type FontSizePickerProps = Pick<ToggleGroupControlProps, '__next40pxDefaultSize' | 'size'> & {
    /**
...
export type FontSizePickerSelectProps = Pick<FontSizePickerProps, 'value' | 'valueMode'> & {
...
export type FontSizePickerToggleGroupProps = Pick<FontSizePickerProps, 'value' | 'valueMode'> & {
    fontSizes: NonNullable<FontSizePickerProps['fontSizes']>;
    onChange: (value: number | string | undefined, selectedItem?: FontSize) => void;
};
