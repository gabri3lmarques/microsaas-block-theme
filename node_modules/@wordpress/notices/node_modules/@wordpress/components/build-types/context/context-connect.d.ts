 ...
 * @return The connected WordPressComponent
 */
export declare function contextConnectWithoutRef<P>(Component: (props: P) => ReactNode, namespace: string): WordPressComponentFromProps<P, false>;
/**
