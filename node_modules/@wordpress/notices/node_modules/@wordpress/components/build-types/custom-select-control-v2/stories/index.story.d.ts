...
export default meta;
export declare const Default: import("storybook/internal/csf").AnnotatedStoryFn<import("@storybook/react").ReactRenderer, import("../types").CustomSelectButtonProps & {
    className?: string;
 ...
 * change accordingly.
 */
export declare const MultipleSelection: import("storybook/internal/csf").AnnotatedStoryFn<import("@storybook/react").ReactRenderer, import("../types").CustomSelectButtonProps & {
    className?: string;
    children: React.ReactNode;
    hideLabelFromVision?: boolean;
    label: string;
 ...
 */
export declare const CustomSelectedValue: import("storybook/internal/csf").AnnotatedStoryFn<import("@storybook/react").ReactRenderer, import("../types").CustomSelectButtonProps & {
    className?: string;
    children: React.ReactNode;
    hideLabelFromVision?: boolean;
    label: string;
