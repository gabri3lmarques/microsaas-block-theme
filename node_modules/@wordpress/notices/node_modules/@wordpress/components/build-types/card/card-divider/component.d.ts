...
export declare const CardDivider: {
    (props: WordPressComponentProps<Omit<import("@ariakit/react").SeparatorProps, "as" | "children" | "orientation" | "render" | "unstable_system"> & {
    ...
    } & import("react").RefAttributes<any>, "hr", false>): React.ReactNode;
    displayName?: string;
    selector?: `.${string}`;
};
