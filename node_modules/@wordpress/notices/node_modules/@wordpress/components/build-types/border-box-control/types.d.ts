...
export type BorderBoxControlProps = ColorProps & LabelProps & Pick<BorderControlProps, 'enableStyle' | '__next40pxDefaultSize' | 'size'> & {
    /**
...
export type SplitControlsProps = ColorProps & Pick<BorderBoxControlProps, 'enableStyle'> & {
    /**
