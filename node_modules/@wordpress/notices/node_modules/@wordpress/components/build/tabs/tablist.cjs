...
var TabList = (0, import_element.forwardRef)(function TabList2({
  ...
  const selectedId = (0, import_react.useStoreState)(store, "selectedId");
  const selectOnMove = (0, import_react.useStoreState)(store, "selectOnMove");
  const items = (0, import_react.useStoreState)(store, "items");
  ...
  const renderedItems = (0, import_react.useStoreState)(store, "renderedItems");
