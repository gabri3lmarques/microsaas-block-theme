...
function ToggleGroupControlOptionBase(props, forwardedRef) {
  ...
  const labelClasses = (0, import_clsx.default)(style_module_default.label, isBlock && style_module_default["label-block"]);
  const itemClasses = (0, import_clsx.default)(style_module_default.button, {
