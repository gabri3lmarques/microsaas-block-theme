...
// packages/components/src/item-group/item/hook.ts
var sizeClassName = {
  small: style_module_default["is-size-small"],
  medium: style_module_default["is-size-medium"],
  large: style_module_default["is-size-large"]
};
function useItem(props) {
  ...
  const classes = (0, import_clsx.default)(style_module_default.item, as === "button" && style_module_default["is-unstyled-button"], as === "a" && style_module_default["is-unstyled-link"], sizeClassName[size] || sizeClassName.medium, spacedAround && style_module_default["is-spaced-around"], className);
  const wrapperClassName = style_module_default["item-wrapper"];
  return {
    as,
    className: classes,
    onClick,
