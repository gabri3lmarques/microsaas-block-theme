...
var import_use_menu_item_hide_on_click = require("./use-menu-item-hide-on-click.cjs");
...
var Item2 = (0, import_element.forwardRef)(function Item3({
  ...
  const computedHideOnClick = (0, import_use_menu_item_hide_on_click.useMenuItemHideOnClick)(computedStore, hideOnClick);
