...
export declare const Menu: {
    (props: import("../context").WordPressComponentProps<Props, import("react").ElementType<any, keyof import("react").JSX.IntrinsicElements> | null, boolean>): React.ReactNode;
    displayName?: string;
    selector?: `.${string}`;
} & {
     ...
     */
    Group: import("react").ForwardRefExoticComponent<import("./types").GroupProps & Omit<Omit<import("react").DetailedHTMLProps<import("react").HTMLAttributes<HTMLDivElement>, HTMLDivElement>, "ref">, "as" | "children"> & import("react").RefAttributes<HTMLDivElement>> & {
        displayName: string;
    };
    /**
     ...
     */
    GroupLabel: import("react").ForwardRefExoticComponent<import("./types").GroupLabelProps & Omit<Omit<import("react").DetailedHTMLProps<import("react").HTMLAttributes<HTMLDivElement>, HTMLDivElement>, "ref">, "as" | "children"> & import("react").RefAttributes<HTMLDivElement>> & {
        displayName: string;
    };
    /**
     * Renders a divider between menu items or menu groups.
     */
    Separator: import("react").ForwardRefExoticComponent<import("./types").SeparatorProps & Omit<Omit<import("react").DetailedHTMLProps<import("react").HTMLAttributes<HTMLHRElement>, HTMLHRElement>, "ref">, "as" | "children"> & import("react").RefAttributes<HTMLHRElement>> & {
        displayName: string;
    };
    /**
