...
export declare function useHStack(props: WordPressComponentProps<Props, 'div'>): {
    ...
    style: {
        ...
        '--wp-components-flex-align': import("csstype").Property.AlignItems;
        '--wp-components-flex-direction': "-moz-initial" | "column" | "column-reverse" | "inherit" | "initial" | "revert" | "revert-layer" | "row" | "row-reverse" | "unset" | undefined;
        '--wp-components-flex-wrap': string;
        '--wp-components-flex-gap': string | undefined;
        '--wp-components-flex-justify': import("csstype").Property.JustifyContent;
    };
};
