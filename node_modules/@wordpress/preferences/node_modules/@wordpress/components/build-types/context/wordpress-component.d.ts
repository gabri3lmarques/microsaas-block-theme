 ...
 */
type PolymorphicIntrinsicProps = Omit<React.AllHTMLAttributes<Element> & React.SVGAttributes<Element>, 'as' | 'children'>;
...
IsPolymorphic extends boolean = true> = P & (T extends React.ElementType ? Omit<React.ComponentPropsWithoutRef<T>, 'as' | keyof P | 'children'> : {}) & (IsPolymorphic extends true ? {
    /** The HTML element or React component to render the component as. */
    as?: T | keyof React.JSX.IntrinsicElements | React.JSXElementConstructor<any>;
} : {});
export type WordPressComponent<T extends React.ElementType | null, O, IsPolymorphic extends boolean> = (IsPolymorphic extends true ? {
    /**
    ...
    } & Omit<PolymorphicIntrinsicProps, keyof O>): React.ReactNode;
    /**
     * Component `as` (e.g. `as={ Item }`): remap to that component's props.
     */
    <C extends React.JSXElementConstructor<any>>(props: WordPressComponentProps<O, T, false> & {
        /** The React component to render the component as. */
        as: C;
    } & Omit<React.ComponentPropsWithoutRef<C>, 'as' | keyof O | 'children'>): React.ReactNode;
} : unknown) & {
