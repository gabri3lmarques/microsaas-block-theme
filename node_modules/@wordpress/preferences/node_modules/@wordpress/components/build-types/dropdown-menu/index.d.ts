...
export declare const DropdownMenu: {
    (props: import("../context").WordPressComponentProps<DropdownMenuProps, import("react").ElementType<any, keyof import("react").JSX.IntrinsicElements> | null, boolean>): React.ReactNode;
    displayName?: string;
    selector?: `.${string}`;
};
