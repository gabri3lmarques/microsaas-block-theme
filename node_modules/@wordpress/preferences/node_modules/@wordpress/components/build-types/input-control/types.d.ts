...
export interface InputControlProps extends Omit<InputBaseProps, 'children' | 'isBorderless' | keyof FlexProps>, Pick<BaseControlProps, 'help'>, 
/**
 ...
 */
Omit<WordPressComponentProps<InputFieldProps, 'input', false>, 'stateReducer' | 'prefix' | 'paddingInlineStart' | 'paddingInlineEnd'> {
    /**
