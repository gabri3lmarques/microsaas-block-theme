...
export declare const Root: import("@emotion/styled").StyledComponent<import("../../flex/types").FlexProps & import("react").RefAttributes<any> & Omit<Omit<import("react").DetailedHTMLProps<import("react").HTMLAttributes<HTMLDivElement>, HTMLDivElement>, "ref">, "as" | keyof import("../../flex/types").FlexProps | keyof import("react").RefAttributes<any>> & {
...
export declare const getSizeConfig: ({ inputSize: size }: InputProps) => {
    height: number;
    lineHeight: number;
    minHeight: number;
    paddingLeft: number;
...
export declare const LabelWrapper: import("@emotion/styled").StyledComponent<import("../../flex/types").FlexItemProps & import("react").RefAttributes<any> & Omit<Omit<import("react").DetailedHTMLProps<import("react").HTMLAttributes<HTMLDivElement>, HTMLDivElement>, "ref">, "as" | keyof import("../../flex/types").FlexItemProps | keyof import("react").RefAttributes<any>> & {
    as?: import("react").JSXElementConstructor<any> | keyof import("react").JSX.IntrinsicElements | undefined;
} & {
    theme?: import("@emotion/react").Theme;
}, {}, {}>;
