...
var import_owns_selection = require("../owns-selection.cjs");
...
function useRichTextBase({
  ...
  function applyFromProps() {
    ...
    const hasFocus = ref.current?.contains(ref.current.ownerDocument.activeElement) || (0, import_owns_selection.ownsSelection)(ref.current);
  ...
  (0, import_element.useLayoutEffect)(() => {
    ...
    if (ref.current.ownerDocument.activeElement !== ref.current && !(0, import_owns_selection.ownsSelection)(ref.current)) {
      ref.current.focus();
    }
