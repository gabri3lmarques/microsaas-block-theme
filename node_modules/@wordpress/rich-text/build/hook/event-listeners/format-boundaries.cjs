...
var import_subscribe_owned_listener = require("../../subscribe-owned-listener.cjs");
...
var format_boundaries_default = (props) => (element) => {
  ...
  return (0, import_subscribe_owned_listener.subscribeOwnedListener)(element, "keydown", onKeyDown, true);
};
