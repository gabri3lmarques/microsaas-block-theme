...
export type ToggleGroupControlMainControlProps = Pick<ToggleGroupControlProps, 'children' | 'isAdaptiveWidth' | 'label' | 'onChange' | 'value'> & Pick<ToggleGroupControlContextProps, 'setSelectedElement'>;
