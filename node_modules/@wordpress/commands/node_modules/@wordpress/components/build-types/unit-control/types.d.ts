...
import type { InputChangeCallback, InputControlProps } from '../input-control/types';
...
export type UnitControlProps = Pick<InputControlProps, 'size'> & Omit<UnitSelectControlProps, 'size' | 'unit'> & Omit<NumberControlProps, 'spinControls' | 'suffix' | 'type'> & {
    /**
