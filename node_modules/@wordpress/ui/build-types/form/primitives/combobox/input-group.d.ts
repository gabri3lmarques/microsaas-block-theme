 ...
 */
export declare const InputGroup: import("react").ForwardRefExoticComponent<Omit<Omit<Omit<import("@base-ui/react").ComboboxInputGroupProps, "ref"> & import("react").RefAttributes<HTMLDivElement>, "ref">, "children" | "className" | "render" | "style"> & {
    className?: string;
