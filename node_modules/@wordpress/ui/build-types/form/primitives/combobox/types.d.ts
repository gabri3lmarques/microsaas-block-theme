...
export type ComboboxChipWithRemoveProps = Omit<ComponentProps<typeof _Combobox.Chip>, 'prefix'> & {
    children?: React.ReactNode;
    /**
...
export type ComboboxGroupLabelProps = ComponentProps<typeof _Combobox.GroupLabel> & {
    children?: React.ReactNode;
};
export type ComboboxInputProps = Omit<ComponentProps<typeof _Combobox.Input>, 'size'>;
export type ComboboxInputGroupProps = ComponentProps<typeof _Combobox.InputGroup> & {
    children?: React.ReactNode;
};
...
export type ComboboxRootProps<Value, Multiple extends boolean | undefined = false> = _Combobox.Root.Props<Value, Multiple>;
export type ComboboxTriggerProps = ComponentProps<typeof _Combobox.Trigger> & {
