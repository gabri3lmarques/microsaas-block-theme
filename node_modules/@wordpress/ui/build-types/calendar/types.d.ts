 ...
 */
export type OnValueChangeHandler<T> = (value: T, triggerDate: Date, modifiers: Modifiers, e: React.MouseEvent | React.KeyboardEvent) => void;
export interface BaseProps extends Omit<ComponentProps<'div'>, 'onSelect' | 'defaultValue' | 'role'> {
    /**
