...
var wp_compat_overlay_slot_exports = {};
__export(wp_compat_overlay_slot_exports, {
  WP_COMPAT_OVERLAY_SLOT_ATTRIBUTE: () => WP_COMPAT_OVERLAY_SLOT_ATTRIBUTE,
  __resetWpCompatOverlaySlotCacheForTests: () => __resetWpCompatOverlaySlotCacheForTests,
  getWpCompatOverlaySlot: () => getWpCompatOverlaySlot
});
module.exports = __toCommonJS(wp_compat_overlay_slot_exports);
...
//# sourceMappingURL=wp-compat-overlay-slot.cjs.map
