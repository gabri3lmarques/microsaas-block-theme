...
var import_render_slot_with_children = require("../utils/render-slot-with-children.cjs");
var import_theme_provider = require("../utils/theme-provider.cjs");
var import_context = require("./context.cjs");
var import_portal = require("./portal.cjs");
var import_positioner = require("./positioner.cjs");
...
var Popup = (0, import_element.forwardRef)(function PopoverPopup({
  ...
  const validatedChildren = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_context.PopoverValidationProvider, { children });
  const popupChildren = useDefaultSurface ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: style_default.surface, children: validatedChildren }) : validatedChildren;
  ...
  const popupContent = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_theme_provider.ThemeProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    import_popover.Popover.Popup,
    {
      ...
      className: (0, import_clsx.default)(
        useDefaultSurface && style_default.popup,
        className
      ),
      ...props,
  ...
  const positionedPopup = (0, import_render_slot_with_children.renderSlotWithChildren)(
    positioner,
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_positioner.Positioner, {}),
    popupContent
  );
  ...
  return (0, import_render_slot_with_children.renderSlotWithChildren)(portal, /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_portal.Portal, {}), portalChildren);
});
