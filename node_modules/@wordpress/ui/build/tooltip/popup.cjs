...
var Popup = (0, import_element.forwardRef)(function TooltipPopup({ portal, positioner, children, className, ...props }, ref) {
  const popupContent = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_theme_provider.ThemeProvider, { color: POPUP_COLOR, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
  ...
  return (0, import_render_slot_with_children.renderSlotWithChildren)(portal, /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_portal.Portal, {}), positionedPopup);
});
