...
// packages/ui/src/form/primitives/combobox/list-footer.tsx
var list_footer_exports = {};
__export(list_footer_exports, {
  ListFooter: () => ListFooter
});
module.exports = __toCommonJS(list_footer_exports);
...
// packages/ui/src/form/primitives/combobox/list-footer.tsx
var ListFooter = (0, import_element.forwardRef)(
  function ListFooter2({ render, ...props }, ref) {
    const element = (0, import_react.useRender)({
      defaultTagName: "div",
      render,
      ref,
      props: (0, import_react.mergeProps)(
        { className: item_popup_default["list-footer"] },
        props
      )
    });
    return element;
...
//# sourceMappingURL=list-footer.cjs.map
