...
// packages/ui/src/form/primitives/combobox/group-label.tsx
...
var GroupLabel = (0, import_element.forwardRef)(
  function GroupLabel2({ className, children, ...restProps }, ref) {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      import_text.Text,
      {
        ...
        render: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_combobox.Combobox.GroupLabel, { ref, ...restProps }),
        children
      }
    );
  }
