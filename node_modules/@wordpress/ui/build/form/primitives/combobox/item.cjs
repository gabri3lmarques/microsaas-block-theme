...
// packages/ui/src/form/primitives/combobox/item.tsx
var item_exports = {};
      ...
      import_combobox.Combobox.Item,
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_icon.Icon,
            {
              icon: variant === "creatable" ? import_icons.plus : import_icons.check,
              className: (0, import_clsx.default)(
                item_popup_default["item-icon"],
                variant !== "creatable" && item_popup_default["item-indicator-icon"]
              ),
              size: 24
            }
          ),
