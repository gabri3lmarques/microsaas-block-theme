...
// packages/ui/src/form/primitives/autocomplete/group.tsx
var group_exports = {};
...
var Group = (0, import_element.forwardRef)(
  function Group2({ className, children, ...restProps }, ref) {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      import_autocomplete.Autocomplete.Group,
      {
        className: (0, import_clsx.default)(item_popup_default.group, className),
        ref,
        ...restProps,
        children
      }
