...
// packages/ui/src/calendar/utils/constants.ts
...
// packages/ui/src/calendar/utils/constants.ts
var CLASSNAMES = {
  root: (0, import_clsx.default)(style_default.root, resets_default["box-sizing"]),
  day: style_default.day,
  day_button: (0, import_clsx.default)(
    style_default["day-button"],
    global_css_defense_default.button,
    focus_module_default["outset-ring--focus-visible"]
  ),
  outside: style_default.outside,
  caption_label: style_default["caption-label"],
  button_next: style_default["nav-button"],
  button_previous: style_default["nav-button"],
  chevron: style_default.chevron,
  nav: style_default.nav,
  month_caption: style_default["month-caption"],
  months: style_default.months,
  month_grid: style_default["month-grid"],
  weekday: style_default.weekday,
  today: style_default.today,
  selected: style_default.selected,
  /*
   ...
   */
  disabled: void 0,
  hidden: style_default.hidden,
  range_start: style_default["range-start"],
  range_end: style_default["range-end"],
  range_middle: style_default["range-middle"],
  weeks_before_enter: style_default["weeks-before-enter"],
  weeks_before_exit: style_default["weeks-before-exit"],
  weeks_after_enter: style_default["weeks-after-enter"],
  weeks_after_exit: style_default["weeks-after-exit"],
  caption_after_enter: style_default["caption-after-enter"],
  caption_after_exit: style_default["caption-after-exit"],
  caption_before_enter: style_default["caption-before-enter"],
  caption_before_exit: style_default["caption-before-exit"]
};
var MODIFIER_CLASSNAMES = {
  preview: style_default.preview
};
var COMMON_PROPS = {
  animate: true,
  ...
  role: "application",
  components: {
    Day: import_components.Day,
    Root: import_components.Root,
    Chevron: import_components.Chevron,
    PreviousMonthButton: import_components.NavButton,
    NextMonthButton: import_components.NavButton
  }
};
