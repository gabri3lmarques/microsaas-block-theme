...
var Header2 = (0, import_element.forwardRef)(
  function CollapsibleCardHeader({ children, className, render, ...restProps }, ref) {
    ...
    return (0, import_react.useRender)({
      defaultTagName: "div",
      render,
      ref,
      props: (0, import_react.mergeProps)(restProps, {
        className: (0, import_clsx.default)(
          global_css_defense_default.heading,
          style_default["heading-wrapper"],
          className
        ),
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_context.HeaderDescriptionIdContext.Provider, { value: contextValue, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
          Collapsible.Trigger,
          {
            className: style_default.header,
            render: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card.Header, {}),
            nativeButton: false,
