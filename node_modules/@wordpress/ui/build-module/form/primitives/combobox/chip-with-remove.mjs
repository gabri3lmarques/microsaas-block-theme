...
var ChipWithRemove = forwardRef(function ChipWithRemove2({ className, children, prefix, removeLabel = __("Remove"), ...restProps }, ref) {
  return /* @__PURE__ */ jsxs(
    _Combobox.Chip,
    {
      ref,
      className: clsx(style_default.chip, className),
      ...restProps,
      children: [
        prefix && /* @__PURE__ */ jsx("span", { className: style_default["chip-prefix"], children: prefix }),
        /* @__PURE__ */ jsx("span", { className: style_default["chip-content"], children }),
        /* @__PURE__ */ jsx(
          _Combobox.ChipRemove,
          {
            className: style_default["chip-remove"],
            render: (props, { disabled }) => /* @__PURE__ */ jsx(
              IconButton,
              {
                icon: closeSmall,
                label: removeLabel,
...
//# sourceMappingURL=chip-with-remove.mjs.map
