// packages/ui/src/form/primitives/autocomplete/group-label.tsx
...
var GroupLabel = forwardRef(function GroupLabel2({ className, children, ...restProps }, ref) {
  return /* @__PURE__ */ jsx(
    Text,
    {
      variant: "heading-sm",
      className: clsx(item_popup_default["group-label"], className),
      render: /* @__PURE__ */ jsx(_Autocomplete.GroupLabel, { ref, ...restProps }),
      children
    }
  );
});
