...
import { ThemeProvider } from "../utils/theme-provider.mjs";
...
var Popup = forwardRef(function PopoverPopup({
  ...
  const validatedChildren = /* @__PURE__ */ jsx(PopoverValidationProvider, { children });
  const popupChildren = useDefaultSurface ? /* @__PURE__ */ jsx("div", { className: style_default.surface, children: validatedChildren }) : validatedChildren;
