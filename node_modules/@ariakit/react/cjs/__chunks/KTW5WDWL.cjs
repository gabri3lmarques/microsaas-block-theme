...
var TagName = "h1";
var useHeading = _D3E2TUKRcjs.createHook.call(void 0, function useHeading2(props) {
  const ref = _react.useRef.call(void 0, null);
  const level = _react.useContext.call(void 0, _DWSXHZYMcjs.HeadingContext) || 1;
  const Element = `h${level}`;
  const tagName = _D3E2TUKRcjs.useTagName.call(void 0, ref, Element);
...
var Heading = _D3E2TUKRcjs.forwardRef.call(void 0, function Heading2(props) {
