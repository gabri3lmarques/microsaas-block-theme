...
var ctx = _D3E2TUKRcjs.createStoreContext.call(void 0, [_YVGNT27Jcjs.CollectionContextProvider], [_YVGNT27Jcjs.CollectionScopedContextProvider]);
...
function createCompositeStore(props = {}) {
  ...
  const collection = _YVGNT27Jcjs.createCollectionStore.call(void 0, props);
  const activeId = _D3E2TUKRcjs.defaultValue.call(void 0, props.activeId, syncState == null ? void 0 : syncState.activeId, props.defaultActiveId);
  const compositeElement = _D3E2TUKRcjs.defaultValue.call(void 0, syncState == null ? void 0 : syncState.compositeElement, syncState == null ? void 0 : syncState.baseElement, null);
  const compositeElementInFocusOrder = _D3E2TUKRcjs.defaultValue.call(void 0, props.compositeElementInFocusOrder, props.includesBaseElement, syncState == null ? void 0 : syncState.compositeElementInFocusOrder, syncState == null ? void 0 : syncState.includesBaseElement, activeId === null);
  const initialState = {
    ...collection.getState(),
    id: (_b = _D3E2TUKRcjs.defaultValue.call(void 0, props.id, syncState == null ? void 0 : syncState.id)) != null ? _b : `id-${Math.random().toString(36).slice(2, 8)}`,
    activeId,
    compositeElement,
    baseElement: compositeElement,
    compositeElementInFocusOrder,
    includesBaseElement: compositeElementInFocusOrder,
    moves: _D3E2TUKRcjs.defaultValue.call(void 0, syncState == null ? void 0 : syncState.moves, 0),
    orientation: _D3E2TUKRcjs.defaultValue.call(void 0, props.orientation, syncState == null ? void 0 : syncState.orientation, "both"),
    rtl: _D3E2TUKRcjs.defaultValue.call(void 0, props.rtl, syncState == null ? void 0 : syncState.rtl, false),
    virtualFocus: _D3E2TUKRcjs.defaultValue.call(void 0, props.virtualFocus, syncState == null ? void 0 : syncState.virtualFocus, false),
    focusLoop: _D3E2TUKRcjs.defaultValue.call(void 0, props.focusLoop, syncState == null ? void 0 : syncState.focusLoop, false),
    focusWrap: _D3E2TUKRcjs.defaultValue.call(void 0, props.focusWrap, syncState == null ? void 0 : syncState.focusWrap, false),
    focusShift: _D3E2TUKRcjs.defaultValue.call(void 0, props.focusShift, syncState == null ? void 0 : syncState.focusShift, false)
  };
  const composite = _W5C4UCUZcjs.createStore.call(void 0, initialState, collection, props.store);
  _W5C4UCUZcjs.setup.call(void 0, composite, () => _D3E2TUKRcjs.chain.call(void 0, _W5C4UCUZcjs.sync.call(void 0, composite, ["compositeElement"], (state) => {
    composite.setState("baseElement", state.compositeElement);
  }), _W5C4UCUZcjs.sync.call(void 0, composite, ["baseElement"], (state) => {
    composite.setState("compositeElement", state.baseElement);
  }), _W5C4UCUZcjs.sync.call(void 0, composite, ["compositeElementInFocusOrder"], (state) => {
    composite.setState("includesBaseElement", state.compositeElementInFocusOrder);
  }), _W5C4UCUZcjs.sync.call(void 0, composite, ["includesBaseElement"], (state) => {
    composite.setState("compositeElementInFocusOrder", state.includesBaseElement);
  })));
  _W5C4UCUZcjs.setup.call(void 0, composite, () => _W5C4UCUZcjs.sync.call(void 0, composite, ["renderedItems", "activeId"], (state) => {
  ...
  const getNextId = (direction = "next", options = {}) => {
    ...
    const compositeElementInFocusOrder2 = _D3E2TUKRcjs.defaultValue.call(void 0, options.compositeElementInFocusOrder, options.includesBaseElement, defaultState.compositeElementInFocusOrder);
    ...
    let items = !isVerticalDirection ? renderedItems : _D3E2TUKRcjs.flatten2DArray.call(void 0, normalizeRows(groupItemsByRows(renderedItems), activeId2, canShift));
    items = canReverse ? _D3E2TUKRcjs.reverseArray.call(void 0, items) : items;
...
function markItemUnmounting(element) {
  if (_D3E2TUKRcjs.getActiveElement.call(void 0, element) !== element) return;
...
function withCompositeScrollPreserved(store, callback) {
  ...
  if (!virtualFocus || !compositeElement || !_D3E2TUKRcjs.isTextField.call(void 0, compositeElement)) {
    callback();
    return;
  }
...
function ownsFocus(store) {
  ...
  const activeElement = _D3E2TUKRcjs.getActiveElement.call(void 0, compositeElement);
...
function presentItem({ store, id, focus, markedOnly, requireFocus, scrollIntoView }) {
  ...
  const activeAtStart = _D3E2TUKRcjs.getActiveElement.call(void 0, compositeAtStart);
  ...
  const stillOwnsFocus = (target) => {
    ...
    const activeElement = _D3E2TUKRcjs.getActiveElement.call(void 0, owner);
  ...
  const entersClosedPopup = (state, target) => {
    ...
    return _D3E2TUKRcjs.isVisible.call(void 0, target);
  };
  ...
  const present = () => {
    ...
    if (!element) {
      ...
      restoreFocus = focused && !focusLeftElement && _D3E2TUKRcjs.getActiveElement.call(void 0, element) === _D3E2TUKRcjs.getDocument.call(void 0, element).body;
      element = resolveElement(state);
    ...
    if (!_D3E2TUKRcjs.isVisible.call(void 0, element)) return;
  ...
  unsubscribe = _W5C4UCUZcjs.subscribe.call(void 0, store, [
    "activeId",
    "items",
    "mounted",
    "open",
...
function selectTextField(element, collapseToEnd = false) {
  if (_D3E2TUKRcjs.isTextField.call(void 0, element)) element.setSelectionRange(collapseToEnd ? element.value.length : 0, element.value.length);
  else if (element.isContentEditable) {
    const selection = _D3E2TUKRcjs.getDocument.call(void 0, element).getSelection();
