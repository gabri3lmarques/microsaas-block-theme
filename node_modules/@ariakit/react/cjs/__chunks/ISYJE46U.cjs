...
function getFlipMiddleware(props) {
  ...
  _D3E2TUKRcjs.invariant.call(void 0, !fallbackPlacements || fallbackPlacements.every(isValidPlacement), process.env.NODE_ENV !== "production" && "`flip` expects a spaced-delimited list of placements");
  return flip2({
...
var usePopover = _D3E2TUKRcjs.createHook.call(void 0, function usePopover2({ store, modal = false, portal = modal, preserveTabOrder = true, autoFocusOnShow = true, wrapperProps, fixed = false, flip: flip3 = true, shift: shift3 = 0, slide = true, overlap = false, sameWidth = false, fitViewport = false, gutter, arrowPadding = 4, overflowPadding = 8, getAnchorRect, updatePosition, ...props }) {
  var _a, _b, _c, _d;
  const context = _JR5O3XLBcjs.usePopoverProviderContext.call(void 0, );
  store = store || context;
  _D3E2TUKRcjs.invariant.call(void 0, store, process.env.NODE_ENV !== "production" && "Popover must receive a `store` prop or be wrapped in a PopoverProvider component.");
  const arrowElement = _W5C4UCUZcjs.useStoreState.call(void 0, store, "arrowElement");
  const anchorElement = _W5C4UCUZcjs.useStoreState.call(void 0, store, "anchorElement");
  const shouldPreserveTabOrder = preserveTabOrder && portal && !modal;
  const disclosureElement = _W5C4UCUZcjs.useStoreState.call(void 0, store, shouldPreserveTabOrder ? ["disclosureElement"] : [], (state) => shouldPreserveTabOrder ? state.disclosureElement : null);
  const popoverElement = _W5C4UCUZcjs.useStoreState.call(void 0, store, "popoverElement");
  ...
  const rendered = _W5C4UCUZcjs.useStoreState.call(void 0, store, "rendered");
  ...
  const getAnchorRectProp = _D3E2TUKRcjs.useEvent.call(void 0, getAnchorRect);
  const updatePositionProp = _D3E2TUKRcjs.useEvent.call(void 0, updatePosition);
  ...
  const hiddenWhileUnmounted = !mounted && _BABCI7KFcjs.isHidden.call(void 0, mounted, props.hidden, props.alwaysVisible);
  ...
  _D3E2TUKRcjs.useSafeLayoutEffect.call(void 0, () => {
    ...
    const desync = _W5C4UCUZcjs.sync.call(void 0, currentStore, ["mounted"], (state) => {
  ...
  props = _D3E2TUKRcjs.useWrapElement.call(void 0, props, (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", {
    ...wrapperProps,
    style: {
      position,
      top: 0,
  ...
  props = _D3E2TUKRcjs.useWrapElement.call(void 0, props, (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _JR5O3XLBcjs.PopoverScopedContextProvider, {
    value: store,
    children: element
  }), [store]);
  props = {
  ...
  props = _6NM3VIEBcjs.useDialog.call(void 0, {
    store,
    modal,
    portal,
    preserveTabOrder,
...
var Popover = _6NM3VIEBcjs.createDialogComponent.call(void 0, _D3E2TUKRcjs.forwardRef.call(void 0, function Popover2(props) {
  const htmlProps = usePopover(props);
  return _D3E2TUKRcjs.createElement.call(void 0, TagName, htmlProps);
}), _JR5O3XLBcjs.usePopoverProviderContext);

// ../ariakit-components/dist/popover/popover-store.js
function createPopoverStore({ popover: otherPopover, ...props } = {}) {
  const store = _W5C4UCUZcjs.mergeStore.call(void 0, props.store, _W5C4UCUZcjs.omit.call(void 0, otherPopover, [
    "arrowElement",
    "anchorElement",
    "contentElement",
    "popoverElement",
  ...
  _W5C4UCUZcjs.throwOnConflictingProps.call(void 0, props, store);
  const syncState = store == null ? void 0 : store.getState();
  const dialog = _6NM3VIEBcjs.createDialogStore.call(void 0, {
    ...props,
    store
  });
  const placement = _D3E2TUKRcjs.defaultValue.call(void 0, props.placement, syncState == null ? void 0 : syncState.placement, "bottom");
  const initialState = {
    ...dialog.getState(),
    placement,
    currentPlacement: placement,
    anchorElement: _D3E2TUKRcjs.defaultValue.call(void 0, syncState == null ? void 0 : syncState.anchorElement, null),
    popoverElement: _D3E2TUKRcjs.defaultValue.call(void 0, syncState == null ? void 0 : syncState.popoverElement, null),
    arrowElement: _D3E2TUKRcjs.defaultValue.call(void 0, syncState == null ? void 0 : syncState.arrowElement, null),
    rendered: /* @__PURE__ */ Symbol("rendered"),
    unstable_placing: false
  };
  const popover = _W5C4UCUZcjs.createStore.call(void 0, initialState, dialog, store);
  let syncedAnchorElement = initialState.anchorElement === initialState.disclosureElement ? initialState.anchorElement : null;
  _W5C4UCUZcjs.setup.call(void 0, popover, () => _W5C4UCUZcjs.sync.call(void 0, popover, ["anchorElement", "disclosureElement"], (state) => {
...
function usePopoverStoreProps(store, update, props) {
  _D3E2TUKRcjs.useUpdateEffect.call(void 0, update, [props.popover]);
  _W5C4UCUZcjs.useStoreProps.call(void 0, store, props, "placement");
  return _6NM3VIEBcjs.useDialogStoreProps.call(void 0, store, update, props);
}
function usePopoverStore(props = {}) {
  const [store, update] = _W5C4UCUZcjs.useStore.call(void 0, createPopoverStore, props);
