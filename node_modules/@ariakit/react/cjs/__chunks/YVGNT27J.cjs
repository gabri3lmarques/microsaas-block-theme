...
var ctx = _D3E2TUKRcjs.createStoreContext.call(void 0, );
...
function getCommonParent(items) {
  ...
  if (!lastElement) return _D3E2TUKRcjs.getDocument.call(void 0, parentElement).body;
  while (parentElement) {
    if (parentElement.contains(lastElement)) return parentElement;
    parentElement = parentElement.parentElement;
  }
  return _D3E2TUKRcjs.getDocument.call(void 0, parentElement).body;
}
...
function createCollectionStore(props = {}) {
  var _a, _b;
  _W5C4UCUZcjs.throwOnConflictingProps.call(void 0, props, props.store);
  const syncState = (_a = props.store) == null ? void 0 : _a.getState();
  const items = _D3E2TUKRcjs.defaultValue.call(void 0, props.items, syncState == null ? void 0 : syncState.items, props.defaultItems, []);
  ...
  const initialState = {
    items,
    renderedItems: _D3E2TUKRcjs.defaultValue.call(void 0, syncState == null ? void 0 : syncState.renderedItems, [])
  };
  const collection = _W5C4UCUZcjs.createStore.call(void 0, initialState, props.store);
  const privateStore = Object.assign(_W5C4UCUZcjs.createStore.call(void 0, {
    items,
    renderedItems: initialState.renderedItems
  }, syncPrivateStore), { __unstableCollectionLookup: collectionLookup });
  const sortItems = (renderedItems) => {
    const sortedItems = _D3E2TUKRcjs.sortBasedOnDOMPosition.call(void 0, renderedItems, (i) => i.element);
  ...
  const setState = (key, value) => {
    ...
    collection.setState("items", (items2) => {
      const nextItems = _D3E2TUKRcjs.applyState.call(void 0, value, items2);
  ...
  _W5C4UCUZcjs.setup.call(void 0, collection, () => _W5C4UCUZcjs.init.call(void 0, privateStore));
  if (!syncPrivateStore) {
    _W5C4UCUZcjs.subscribe.call(void 0, collection, ["items"], ({ items: items2 }) => {
      if (items2 === collectionLookup.propagatedItems) return;
      collectionLookup.propagatedItems = items2;
      indexControlledItems(items2);
    });
    _W5C4UCUZcjs.setup.call(void 0, privateStore, () => {
      return _W5C4UCUZcjs.batch.call(void 0, privateStore, ["items"], ({ items: items2 }) => {
        collectionLookup.propagatedItems = items2;
        collection.setState("items", items2);
      });
    });
  ...
  _W5C4UCUZcjs.setup.call(void 0, privateStore, () => {
    return _W5C4UCUZcjs.batch.call(void 0, privateStore, ["renderedItems"], (state) => {
      let firstRun = true;
  ...
  return {
    ...
    setState,
    registerItem,
    renderItem: (item) => _D3E2TUKRcjs.chain.call(void 0, registerItem(item), mergeRenderedItem(item)),
    item: (id) => {
      var _a2, _b2, _c;
      if (!id) return null;
...
function useCollectionStoreProps(store, update, props) {
  _D3E2TUKRcjs.useUpdateEffect.call(void 0, update, [props.store]);
  _W5C4UCUZcjs.useStoreProps.call(void 0, store, props, "items", "setItems");
  return store;
}
function useCollectionStore(props = {}) {
  const [store, update] = _W5C4UCUZcjs.useStore.call(void 0, createCollectionStore, props);
