...
var _ACTY2PLAcjs = require('./ACTY2PLA.cjs');
...
function getRootElement(element) {
  ...
  const HTMLElementClass = (_a = doc.defaultView) == null ? void 0 : _a.HTMLElement;
  if (HTMLElementClass && fullscreenElement instanceof HTMLElementClass) return fullscreenElement;
  return doc.body;
}
function getPortalElement(element, portalElement) {
  if (!portalElement) return _D3E2TUKRcjs.getDocument.call(void 0, element).createElement("div");
...
function attachPortalRef(ref, node) {
  return {
    ref,
    node,
    cleanup: _D3E2TUKRcjs.setRef.call(void 0, ref, node)
  };
}
function detachPortalRef(attached) {
  if (typeof attached.cleanup === "function") attached.cleanup();
  else _D3E2TUKRcjs.setRef.call(void 0, attached.ref, null);
}
var usePortal = _D3E2TUKRcjs.createHook.call(void 0, function usePortal2({ preserveTabOrder, preserveTabOrderAnchor, portalElement, portalRef, portal = true, ...props }) {
  const ref = _react.useRef.call(void 0, null);
  const refProp = _D3E2TUKRcjs.useMergeRefs.call(void 0, ref, props.ref);
  ...
  const portalRefProp = _D3E2TUKRcjs.useLiveRef.call(void 0, portalRef);
  const attachedPortalRefRef = _react.useRef.call(void 0, null);
  ...
  _react.useEffect.call(void 0, () => {
    ...
    const doc = _D3E2TUKRcjs.getDocument.call(void 0, portalNode);
  ...
  _D3E2TUKRcjs.useSafeLayoutEffect.call(void 0, () => {
    ...
    const element = _D3E2TUKRcjs.getDocument.call(void 0, preserveTabOrderAnchor).createElement("span");
  ...
  _react.useEffect.call(void 0, () => {
    ...
    const onFocus = (event) => {
      ...
      if (focusing) return _D3E2TUKRcjs.restoreFocusIn.call(void 0, portalNode);
      raf = requestAnimationFrame(() => {
        _D3E2TUKRcjs.disableFocusIn.call(void 0, portalNode, true);
      });
    };
  ...
  props = _D3E2TUKRcjs.useWrapElement.call(void 0, props, (element) => {
    ...
    element = /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _jsxruntime.Fragment, { children: [
      preserveTabOrder && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _ACTY2PLAcjs.FocusTrap, {
        ref: innerBeforeRef,
        "data-focus-trap": props.id,
        className: "__focus-trap-inner-before",
        onFocus: (event) => {
          if (_D3E2TUKRcjs.isFocusEventOutside.call(void 0, event, portalNode)) queueFocus(_D3E2TUKRcjs.getNextTabbable.call(void 0, ));
      ...
      preserveTabOrder && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _ACTY2PLAcjs.FocusTrap, {
        ...
        onFocus: (event) => {
          if (_D3E2TUKRcjs.isFocusEventOutside.call(void 0, event, portalNode)) queueFocus(_D3E2TUKRcjs.getPreviousTabbable.call(void 0, ));
    ...
    let preserveTabOrderElement = /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _jsxruntime.Fragment, { children: [
      preserveTabOrder && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _ACTY2PLAcjs.FocusTrap, {
        ...
        onFocus: (event) => {
          if (!(event.relatedTarget === outerAfterRef.current) && _D3E2TUKRcjs.isFocusEventOutside.call(void 0, event, portalNode)) queueFocus(innerBeforeRef.current);
          else queueFocus(_D3E2TUKRcjs.getPreviousTabbable.call(void 0, ));
        }
      }),
      ...
      preserveTabOrder && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _ACTY2PLAcjs.FocusTrap, {
        ...
        onFocus: (event) => {
          if (_D3E2TUKRcjs.isFocusEventOutside.call(void 0, event, portalNode)) queueFocus(innerAfterRef.current);
          else {
            const nextTabbable = _D3E2TUKRcjs.getNextTabbable.call(void 0, );
            if (nextTabbable === innerBeforeRef.current) {
              requestAnimationFrame(() => {
                var _a;
                return (_a = _D3E2TUKRcjs.getNextTabbable.call(void 0, )) == null ? void 0 : _a.focus();
              });
              return;
            }
...
var Portal = _D3E2TUKRcjs.forwardRef.call(void 0, function Portal2(props) {
