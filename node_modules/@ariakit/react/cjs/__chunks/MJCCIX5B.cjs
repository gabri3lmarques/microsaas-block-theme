...
// ../ariakit-react-components/dist/__chunks/CKgCZrim.js
...
function onGlobalMouseDown(event) {
  ...
  if (_D3E2TUKRcjs.isElement.call(void 0, target) && !target.hasAttribute("data-focus-visible")) isKeyboardModality = false;
}
...
var useFocusable = _D3E2TUKRcjs.createHook.call(void 0, function useFocusable2({ focusable = true, accessibleWhenDisabled, autoFocus, onFocusVisible, ...props }) {
  const ref = _react.useRef.call(void 0, null);
  const [parentAccessibleWhenDisabled, metadataProps] = _D3E2TUKRcjs.useMetadataProps.call(void 0, props, accessibleWhenDisabledSymbol, accessibleWhenDisabled);
  ...
  _react.useEffect.call(void 0, () => {
    ...
    _D3E2TUKRcjs.addGlobalEventListener.call(void 0, "mousedown", onGlobalMouseDown, true);
    _D3E2TUKRcjs.addGlobalEventListener.call(void 0, "keydown", onGlobalKeyDown, true);
    hasInstalledGlobalEventListeners = true;
  }, [focusable]);
  const disabled = focusable && _D3E2TUKRcjs.disabledFromProps.call(void 0, props);
  ...
  const cleanupFocusVisible = _D3E2TUKRcjs.useEvent.call(void 0, (element) => {
    var _a;
  ...
  _react.useEffect.call(void 0, () => {
    ...
    const observer = new IntersectionObserver(() => {
      if (!_D3E2TUKRcjs.isFocusable.call(void 0, element)) {
        focusVisibleRef.current = false;
  ...
  const handleFocusVisible = (event, currentTarget) => {
    ...
    if (isNativeSubmitControl(element)) {
      ...
      if (typeof IntersectionObserver !== "undefined") {
        const observer = new IntersectionObserver(() => {
          if (_D3E2TUKRcjs.isFocusable.call(void 0, element)) return;
  ...
  const onKeyDownCapture = _D3E2TUKRcjs.useEvent.call(void 0, (event) => {
    ...
    _D3E2TUKRcjs.queueBeforeEvent.call(void 0, element, "focusout", applyFocusVisible);
  });
  ...
  const onFocusCapture = _D3E2TUKRcjs.useEvent.call(void 0, (event) => {
    ...
    if (event.defaultPrevented) return;
    if (!focusable) return;
    if (!_D3E2TUKRcjs.isSelfTarget.call(void 0, event)) {
      setFocusVisible(false);
      return;
    }
    const element = event.currentTarget;
    const applyFocusVisible = () => handleFocusVisible(event, element);
    if (isKeyboardModality || isAlwaysFocusVisible(event.target)) _D3E2TUKRcjs.queueBeforeEvent.call(void 0, event.target, "focusout", applyFocusVisible);
  ...
  const onBlur = _D3E2TUKRcjs.useEvent.call(void 0, (event) => {
    ...
    if (!focusable) return;
    if (!_D3E2TUKRcjs.isFocusEventOutside.call(void 0, event)) return;
    cleanupFocusVisible(event.currentTarget);
    setFocusVisible(false);
  });
  const autoFocusOnShow = _react.useContext.call(void 0, FocusableContext);
  const autoFocusRef = _D3E2TUKRcjs.useEvent.call(void 0, (element) => {
    if (!focusable) return;
    if (!autoFocus) return;
    if (!element) return;
  ...
  if (isSafariBrowser) _react.useEffect.call(void 0, () => {
    ...
    setSafariTabIndex(_D3E2TUKRcjs.isButton.call(void 0, element) || isNativeCheckboxOrRadio);
  }, [focusable]);
  ...
  props = {
    ...
    ...props,
    ...metadataProps,
    ref: _D3E2TUKRcjs.useMergeRefs.call(void 0, ref, autoFocusRef, props.ref),
    style,
...
var Focusable = _D3E2TUKRcjs.forwardRef.call(void 0, function Focusable2(props) {
...
exports.FocusableContext = FocusableContext; exports.isCompositeMoveKey = isCompositeMoveKey; exports.useFocusable = useFocusable; exports.Focusable = Focusable;
