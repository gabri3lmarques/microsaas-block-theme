...
var require_use_sync_external_store_shim_production = _D3E2TUKRcjs.__commonJS.call(void 0, {
  "../../node_modules/.pnpm/use-sync-external-store@1.6.0_react@19.2.8/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.production.js"(exports) {
    "use strict";
    var React2 = _D3E2TUKRcjs.__require.call(void 0, "react");
    function is(x, y) {
...
var require_use_sync_external_store_shim_development = _D3E2TUKRcjs.__commonJS.call(void 0, {
...
var require_shim = _D3E2TUKRcjs.__commonJS.call(void 0, {
...
function getInternal(store, key) {
  ...
  _D3E2TUKRcjs.invariant.call(void 0, internals, "Invalid store");
...
function getCleanupPrevState(prevState, state, stateBeforeCleanup, updatedKey) {
  ...
  for (const key of _D3E2TUKRcjs.getKeys.call(void 0, state)) {
...
function createStore(initialState, ...stores) {
  ...
  const storeInit = () => {
    ...
    const stateKeys = _D3E2TUKRcjs.getKeys.call(void 0, state);
    const desyncs = [];
    for (const store of stores) {
      const storeState = (_a = store == null ? void 0 : store.getState) == null ? void 0 : _a.call(store);
      if (!storeState) continue;
      const keys = stateKeys.filter((key) => _D3E2TUKRcjs.hasOwnProperty.call(void 0, storeState, key));
    ...
    destroy = _D3E2TUKRcjs.chain.call(void 0, ...desyncs, ...teardowns, ...cleanups);
    return maybeDestroy;
  };
  ...
  const storePick = (keys) => createStore(_D3E2TUKRcjs.pick.call(void 0, state, keys), finalStore);
  const storeOmit = (keys) => createStore(_D3E2TUKRcjs.omit.call(void 0, state, keys), finalStore);
  ...
  const setState = (key, value, fromStores = false) => {
    var _a, _b;
    if (!_D3E2TUKRcjs.hasOwnProperty.call(void 0, state, key)) return;
    const currentValue = state[key];
    const nextValue = _D3E2TUKRcjs.applyState.call(void 0, value, () => currentValue);
...
function throwOnConflictingProps(props, store) {
  ...
  if (!defaultKeys.filter((key) => _D3E2TUKRcjs.hasOwnProperty.call(void 0, storeState, key)).length) return;
...
var import_shim = _D3E2TUKRcjs.__toESM.call(void 0, require_shim(), 1);
...
function hasSameStoreKeys(keys, otherKeys) {
  if ((keys == null ? void 0 : keys.length) !== otherKeys.length) return false;
  for (let index = 0; index < keys.length; index += 1) {
    const key = keys[index];
    if (key === void 0) return false;
    if (isSameValue2(key, otherKeys[index])) continue;
    return false;
  }
  return true;
}
...
function useStoreState(store, keyOrKeysOrSelector = _D3E2TUKRcjs.identity, selector) {
  ...
  const storeSubscribe = React.useCallback((callback) => {
    ...
    if ((subscriptionKeys == null ? void 0 : subscriptionKeys.length) === 0) return noopSubscribe();
    return subscribe(store, subscriptionKeys, callback);
  }, [store, subscriptionKeys]);
  const getSnapshot = () => {
    const state = store == null ? void 0 : store.getState();
    if (isStoreKeyArray(keyOrKeysOrSelector)) return selector == null ? void 0 : selector(state);
    if (typeof keyOrKeysOrSelector === "function") return keyOrKeysOrSelector(state);
    if (!state) return;
    if (!_D3E2TUKRcjs.hasOwnProperty.call(void 0, state, keyOrKeysOrSelector)) return;
...
function useStoreStateObject(store, objectOrKeys, object) {
  const stateObject = isStoreKeyArray(objectOrKeys) ? object != null ? object : {} : objectOrKeys;
  ...
  const getSnapshot = () => {
    ...
    for (const prop in stateObject) {
      ...
      const value = state && _D3E2TUKRcjs.hasOwnProperty.call(void 0, state, keyOrSelector) ? state[keyOrSelector] : void 0;
...
function useStoreProps(store, props, key, setKey) {
  const value = _D3E2TUKRcjs.hasOwnProperty.call(void 0, props, key) ? props[key] : void 0;
  const setValue = setKey ? props[setKey] : void 0;
  const hasSetValue = !!setValue;
  const propsRef = _D3E2TUKRcjs.useLiveRef.call(void 0, {
    value,
    setValue
  });
...
function useStore(createStore2, props) {
  ...
  _D3E2TUKRcjs.useSafeLayoutEffect.call(void 0, () => init(store), [store]);
  const useState2 = React.useCallback((keyOrSelector) => useStoreState(store, keyOrSelector), [store]);
  return [React.useMemo(() => ({
    ...store,
    useState: useState2
  }), [store, useState2]), _D3E2TUKRcjs.useEvent.call(void 0, () => {
