...
const useTagList = createHook(function useTagList({ store, ...props }) {
	...
	const itemIds = useStoreState(store, "renderedItems").filter((item) => !!item.value).map((item) => item.id);
