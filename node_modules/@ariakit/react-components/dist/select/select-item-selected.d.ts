...
//#region src/select/select-item-selected.d.ts
/**
 ...
 * ```
 */
declare function SelectItemSelected({ children }: SelectItemSelectedProps): ReactNode;
/** @deprecated Use `ComboboxItemSelectedProps` instead. */
interface SelectItemSelectedProps {
  /**
...
//#endregion
export { SelectItemSelected, SelectItemSelectedProps };
//# sourceMappingURL=select-item-selected.d.ts.map