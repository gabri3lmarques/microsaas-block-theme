 ...
 * ```
 */
declare const useSelect: import("@ariakit/react-utils").Hook<"button", SelectOptions<"button">>;
/**
...
type SelectProps<T extends ElementType = TagName> = Props<T, SelectOptions<T>>;
//#endregion
export { Select, SelectOptions, SelectProps, useSelect };
