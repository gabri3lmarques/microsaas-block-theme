...
import { n as DialogDisclosureOptions } from "../dialog-disclosure-COACOreW.js";
...
interface PopoverDisclosureOptions<T extends ElementType = TagName> extends Omit<DialogDisclosureOptions<T>, "store"> {
  /**
