...
//#region src/combobox/combobox-item-selected.d.ts
/**
 ...
 * ```
 */
declare function ComboboxItemSelected({ children }: ComboboxItemSelectedProps): ReactNode;
interface ComboboxItemSelectedProps {
  /**
...
//#endregion
export { ComboboxItemSelected, ComboboxItemSelectedProps };
//# sourceMappingURL=combobox-item-selected.d.ts.map