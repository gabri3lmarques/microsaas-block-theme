import { s as ComboboxStoreState, t as ComboboxStore } from "../combobox-store-FilGAecN.js";
import { ReactNode } from "react";
//#region src/combobox/combobox-input-value.d.ts
/**
 * Renders the current
 ...
 * ```
 */
declare function ComboboxInputValue({ store, children }?: ComboboxInputValueProps): ReactNode;
interface ComboboxInputValueProps {
  /**
...
//#endregion
export { ComboboxInputValue, ComboboxInputValueProps };
//# sourceMappingURL=combobox-input-value.d.ts.map