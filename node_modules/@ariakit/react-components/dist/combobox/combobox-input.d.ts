import { ComboboxOptions, ComboboxProps } from "./combobox.js";
 ...
 */
declare const useComboboxInput: import("@ariakit/react-utils").Hook<"input", ComboboxOptions<"input">>;
/**
 ...
 * ```
 */
declare const ComboboxInput: (props: ComboboxProps) => import("react").ReactElement<unknown, string | import("react").JSXElementConstructor<any>>;
interface ComboboxInputOptions<T extends ElementType = TagName> extends ComboboxOptions<T> {}
type ComboboxInputProps<T extends ElementType = TagName> = ComboboxProps<T>;
//#endregion
export { ComboboxInput, ComboboxInputOptions, ComboboxInputProps, useComboboxInput };
