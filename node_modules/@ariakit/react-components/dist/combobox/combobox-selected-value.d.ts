...
//#region src/combobox/combobox-selected-value.d.ts
 ...
 */
declare function ComboboxSelectedValue<T extends Value = Value>(props: PickRequired<ComboboxSelectedValueProps<T>, "fallback">): T;
declare function ComboboxSelectedValue(props?: ComboboxSelectedValueProps): Value;
interface ComboboxSelectedValueProps<T extends Value = Value> {
  /**
...
//#endregion
export { ComboboxSelectedValue, ComboboxSelectedValueProps };
//# sourceMappingURL=combobox-selected-value.d.ts.map