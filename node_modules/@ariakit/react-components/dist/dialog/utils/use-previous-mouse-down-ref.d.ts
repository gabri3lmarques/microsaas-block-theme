 ...
 * document.
 */
declare function getFrameChain(element: Element): Element[];
/**
 ...
 */
declare function getEventTargets(event: Event, referenceElement?: Element | null): EventTargets;
/**
 ...
 */
declare function usePreviousMouseDownRef(enabled?: boolean, scope?: Window, referenceElement?: Element | null): import("react").RefObject<EventTargets | null>;
//#endregion
export { EventTargets, getEventTargets, getFrameChain, usePreviousMouseDownRef };
